  ...
  <tbody>
    <tr>
      <td width="75%" align="left">
        <strong>Gradient overlay over landscape texture</strong>
      </td>
      <td width="25%"></td>
    </tr>
    <tr>
      <td width="75%" align="center">
        <img src="docs/images/gradient-overlay-landscape.png" width="100%" alt="Landscape image with procedural gradient mesh overlay">
      </td>
      <td width="25%" valign="top">
        ...
        <pre><code class="language-lua">require "examples/gradient_overlay"</code></pre>
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      <th width="50%">Texture masking over rotated polygon meshes</th>
      <th width="50%">Hexagon portrait texture masking</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <td align="center">
        <img src="docs/images/texture-mask-rotated-mesh.png" width="100%" alt="Texture mask over square and rotated polygon mesh">
      </td>
      <td align="center">
        <img src="docs/images/hexagon-portrait-texture-mask.png" width="100%" alt="Portrait texture masked through regular hexagon meshes">
      </td>
    </tr>
    <tr>
      <td>
        <strong>Generated from:</strong>
        <pre><code class="language-lua">require "examples/texture_mask_rotated_mesh"</code></pre>
      </td>
      <td>
        <strong>Generated from:</strong>
        <pre><code class="language-lua">require "examples/hexagon_portrait_texture_mask"</code></pre>
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      <th width="50%">Radial shapes, holes, and deformation</th>
      <th width="50%">Splash texture masks</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <td align="center">
        <img src="docs/images/radial-shapes-hole-deform.png" width="100%" alt="Radial gradient shapes with hole and deformation">
      </td>
      <td align="center">
        <img src="docs/images/radial-gradient-splash-masks.png" width="100%" alt="Radial gradient splash texture masks">
      </td>
    </tr>
    <tr>
      <td>
        <strong>Generated from:</strong>
        <pre><code class="language-lua">require "examples/radial_shapes_hole_deform"</code></pre>
      </td>
      <td>
        <strong>Generated from:</strong>
        <pre><code class="language-lua">require "examples/radial_gradient_splash_masks"</code></pre>
      </td>
    </tr>
  </tbody>
</table>
